...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (inventoryObject != null)
        {
            ...
            {
                Debug.LogError("InventoryManager script not found on the Inventory GameObject.");
            }
        }
        else
        {
            Debug.LogError("Inventory GameObject not found in the scene.");
        }
    }
    ...
    private void Update()
    {
        ...
        if (Input.GetButtonDown("Fire1")) // Assuming "Fire1" is mapped to the left mouse button
        {
            Fire();
        }
    }
    ...
    /// <summary>
    /// Handles firing the currently equipped weapon.
    /// </summary>
    private void Fire()
    {
        // Get the currently selected weapon type from the inventory
        Gun currentGun = inventoryManager.GetCurrentWeapon();
        InventoryManager.WeaponType currentWeaponType = currentGun != null ? currentGun.weaponType : InventoryManager.WeaponType.None;
        ...
        if (currentGun.weaponType == currentWeaponType)
        {
